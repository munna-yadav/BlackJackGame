...
function rendergame(){
    ...
    if(sum<=20){
        document.getElementById("message").textContent="do you want to take another card😀 "        
        isAlive=true
    }
    else if(sum===21){
        document.getElementById("message").textContent="whoo! you got the balckjack!!😀 "        
        isAlive=false
    }
    else{
...
function startgame(){
        ...
        let secondCardd=getRandomCard2()
